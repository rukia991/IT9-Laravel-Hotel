...
<form class="form-signin" action="{{ route('register') }}" method="POST">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="form-label-group">
                <input type="password" id="password" name="password" autocomplete="new-password" class="form-control" placeholder="Password" value="" required>
                <label for="password">Password</label>
            </div>
            <div class="form-label-group">
                <input type="password" id="password_confirmation" name="password_confirmation" class="form-control" placeholder="Repeat Password" value="" required>
    ...
    <div class="row">
        <div class="col-lg-12 d-flex justify-content-center">
            <button class="btn btn-lg btn-primary text-white btn-block text-uppercase" type="submit">Submit</button>
        </div>
    </div>
    <hr class="my-4">
