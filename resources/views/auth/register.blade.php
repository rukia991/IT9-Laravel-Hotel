                        ...
                        <div class="row mb-3">
                            <div class="col-lg-12">
                                <div class="d-flex justify-content-center">
                                    <img src="img/logo/hotel.png" width="140" height="100" class="rounded-circle mx-auto"
                                        alt="logo" style="background-color: none;">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-label-group">
                                        <input type="password" id="password_confirmation" name="password_confirmation"
                                            class="form-control" placeholder="Repeat Password" value="" required>
