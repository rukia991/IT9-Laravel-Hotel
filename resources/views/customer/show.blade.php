        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <div class="room-gallery">
                    <img src="{{ $room->image }}"
                        ...
                        alt="{{ $room->name }}" class="main-image shadow">
            ...
            <div class="col-lg-4">
                <div class="card booking-card shadow">
                    <div class="card-body">
                        <h3 class="price-tag mb-3">₱{{ number_format($room->price, 2) }}<small class="text-muted"> /
                                night</small></h3>

                        @guest
                            <div class="alert alert-info">
                                Please <a href="{{ route('login') }}">login</a> or <a
                                    href="{{ route('register') }}">register</a> to book this room.
                            </div>
                        @endguest
                            ...
                            <form id="bookingForm" action="{{ route('booking.store') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('check_out') is-invalid @enderror"
                                        id="check_out" name="check_out" required value="{{ old('check_out') }}">
                                    @error('check_out')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('guests') is-invalid @enderror" id="guests" name="guests"
                                        required>
